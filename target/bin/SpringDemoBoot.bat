...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="SpringDemoBoot" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" SpringBootTelegramApplication %CMD_LINE_ARGS%
